...
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'xiada-customer-profile'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [customer-database->customer-database, rest-service-db->xiada-customer-profi...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [my-project->xiada-customer-profi...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=saragluna&repo=xi'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [rest-service-db->xiada-customer-profi...(truncated)]
